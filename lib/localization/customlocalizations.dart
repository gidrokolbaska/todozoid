...
class MyLocalizations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        ...
        'de_DE': {
          'welcome':
              'Willkommen bei Todozoid! Bitte einloggen, um fortzufahren.',
          'termsandconditions1': 'Mit der Anmeldung stimmen Sie unseren zu ',
          'termsandconditions2': 'Geschäftsbedingungen.',
          'dashboard': 'Dashboard',
          'tasks': 'Aufgaben',
          'lists': 'Listen',
          'work': 'Arbeit',
          ...
          'view': 'Aussicht',
          'thisweek': 'Diese Woche abgeschlossene Aufgaben',
          'createTask': 'Aufgabe erstellen',
          'updateTask': 'Aufgabe aktualisieren',
          'newTaskTextField': 'Neue Aufgabe',
          'category': 'Kategorie',
          'day': 'Tag',
          'time': 'Zeit',
          'selectDay': 'Tag auswählen',
          'selectTime': 'Zeit auswählen',
          'note': 'Schreib eine Notitz...',
          'addSubtask': 'Unteraufgabe hinzufügen',
          'newSubtaskTextField': 'Neue Unteraufgabe',
          'sortByDate': 'Datum',
          'sortByDescription': 'Beschreibung',
          'sortByCategory': 'Kategorie',
          'when': 'Wann',
          'edit': 'Bearbeiten',
          'delete': 'Löschen',
          'cancel': 'Absagen',
          ...
          'listNameTextField': 'Neue Liste benennen',
          'pickIcon': 'Symbol auswählen (optional)',
          ...
          'today': 'Heute',
          'tomorrow': 'Morgen',
          'overdue': 'Aufgabe ist überfällig',
          'remindToday': 'Erinnern Sie sich noch heute an ',
          'remindTomorrow': 'Morgen um erinnern ',
          'at': 'an',
          'signOut': 'Ausloggen',
          ...
          'amountOfRepeats': 'Anzahl der Wiederholungen',
          'intervalOfRepeats': 'Wiederholungsintervall (min)',
          'deleteAccount': 'Konto löschen',
          'alert': 'Alarm',
          'alertDescription':
              'Das Löschen des Kontos erfordert eine Internetverbindung',
          'warning': 'Warnung',
          'areYouSure':
              'Sind Sie sicher, dass Sie Ihre Daten aus einer Anwendung löschen möchten?',
          'yes': 'Ja (erfordert erneute Authentifizierung)',
          'no': 'Nein',
          'error': 'Fehler',
          'sameAccount':
              'Verwenden Sie dasselbe Konto für die erneute Authentifizierung',
        },
        'cs_CS': {
          'welcome': 'Vítejte v Todozoid! Chcete-li pokračovat, přihlaste se.',
          'termsandconditions1': 'Přihlášením souhlasíte s našími ',
          'termsandconditions2': 'obchodními podmínkami.',
          'dashboard': 'Dashboard',
          'tasks': 'Úkoly',
          'lists': 'Seznamy',
          'work': 'Práce',
          ...
          'newSubtaskTextField': 'Nový dílčí úkol',
          'sortByDate': 'Datum',
          'sortByDescription': 'Popis',
          'sortByCategory': 'Kategorie',
          'when': 'Když',
          'edit': 'Upravit',
          'delete': 'Vymazat',
          ...
          'updateList': 'Aktualizovat seznam',
          'listNameTextField': 'Pojmenujte nový seznam',
          'pickIcon': 'Vybrat ikonu (volitelné)',
          ...
          'today': 'Dnes',
          'tomorrow': 'Zítra',
          'overdue': 'Úkol je zpožděný',
          'remindToday': 'Připomeňte dnes v ',
          'remindTomorrow': 'Připomeňte zítra v ',
          'at': 'v',
          'signOut': 'Odhlásit se',
          'categoryName': 'Název Kategorie',
          'newItem': 'Nový předmět',
          'taskReminder': 'Připomenutí úkolu',
          'notifications': 'Oznámení',
          'amountOfRepeats': 'Počet opakování',
          'intervalOfRepeats': 'Interval opakování (min)',
          'deleteAccount': 'Smazat účet',
          'alert': 'Upozornění',
          'alertDescription': 'Smazání účtu vyžaduje připojení k internetu',
          'warning': 'Varování',
          'areYouSure': 'Jste si jisti, že chcete smazat svá data z aplikace?',
          'yes': 'Ano (vyžaduje opětovné ověření)',
          'no': 'Ne',
          'error': 'Chyba',
          'sameAccount': 'Pro opětovné ověření použijte stejný účet',
        },
      };
}
