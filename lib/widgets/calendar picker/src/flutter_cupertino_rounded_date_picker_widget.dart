...
const double _kDatePickerPadSize = 25.0;
...
class FlutterRoundedCupertinoDatePickerWidget extends StatefulWidget {
  ...
  FlutterRoundedCupertinoDatePickerWidget(
    ...
    assert(
      ...
      'initial minute is not divisible by minute interval, initialDateTime.minute=${this.initialDateTime.minute}',
    );
  }
    ...
    switch (columnType) {
      ...
      case _PickerColumnType.month:
        for (int i = 1; i <= 12; i++) {
          ...
          } // Add more length of month name for Thai tone marks
        }
        break;
    ...
    return CupertinoPicker.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        if (widget.maximumDate != null &&
            dateTime.isAfter(widget.maximumDate!)) {
          return null;
        }
    ...
    return CupertinoPicker(
      selectionOverlay: CupertinoPickerDefaultSelectionOverlay(
          background: Get.isDarkMode
              ? Constants.kDarkThemeLightOnLightColor.withOpacity(0.3)
              : Constants.kLightGrayColor2.withOpacity(0.3)),
        ...
        child: DefaultTextStyle.merge(
          ...
          child: Column(
            children: [
              GestureDetector(
                onTap: () async {
                  // print('oioioioi ${_getDateTime()}');
                  Navigator.of(context).pop(_getDateTime());
                  // Get.back(result: _getDateTime());
                },
                child: const Icon(
  ...
  Widget _buildYearPicker(
    ...
    return CupertinoPicker.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        if (widget.era == EraMode.buddhistYear) {
