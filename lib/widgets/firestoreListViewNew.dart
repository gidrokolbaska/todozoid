...
import 'firestoreQueryBuilderNew.dart';
...
/// A type representing the function passed to [FirestoreListViewNew] for its `itemBuilder`.
typedef FirestoreItemBuilder<Document> = Widget Function(
  BuildContext context,
  QueryDocumentSnapshot<Document> doc,
);

/// A type representing the function passed to [FirestoreListViewNew] for its `loadingBuilder`.
typedef FirestoreLoadingBuilder = Widget Function(BuildContext context);

/// A type representing the function passed to [FirestoreListViewNew] for its `errorBuilder`.
...
///
///
/// Using [FirestoreListViewNew], we can now show the list of movies by writing:
///
/// ```dart
