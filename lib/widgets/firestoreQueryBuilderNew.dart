...
///
/// [FirestoreQueryBuilderNew] will subscribe to the query and obtain the first
...
///
/// [FirestoreQueryBuilderNew] is independent from how the query will be rendered
/// and as such can be used with any existing widget for rendering list of items.
///
/// An example of how to combine [FirestoreQueryBuilderNew] with [ListView] would be:
///
/// ```dart
...
class FirestoreQueryBuilderNew<Document> extends StatefulWidget {
  /// {@macro firebase_ui.firestore_query_builder}
  const FirestoreQueryBuilderNew({
    Key? key,
    required this.query,
  ...
  _FirestoreQueryBuilderNewState<Document> createState() =>
      _FirestoreQueryBuilderNewState<Document>();
}

class _FirestoreQueryBuilderNewState<Document>
    extends State<FirestoreQueryBuilderNew<Document>> {
  ...
  @override
  void didUpdateWidget(FirestoreQueryBuilderNew<Document> oldWidget) {
...
/// ```
///
/// For advanced UI use-cases, consider switching to [FirestoreQueryBuilderNew].
/// {@endtemplate}
/// {@subCategory service:firestore}
/// {@subCategory type:widget}
/// {@subCategory description:A widget that listens to a query and display the items using a ListView}
/// {@subCategory img:https://place-hold.it/400x150}
class FirestoreListViewNew<Document>
    extends FirestoreQueryBuilderNew<Document> {
  /// {@macro flutterfire_ui.firestorelistview}
  FirestoreListViewNew({
    Key? key,
